package br.com.emanuelgabriel.brasileiraoapi.controller;
...
import br.com.emanuelgabriel.brasileiraoapi.dto.PartidaDTO;
import br.com.emanuelgabriel.brasileiraoapi.dto.PartidaModelResponse;
import br.com.emanuelgabriel.brasileiraoapi.execption.StandardError;
import br.com.emanuelgabriel.brasileiraoapi.model.Partida;
import br.com.emanuelgabriel.brasileiraoapi.service.PartidaService;
...
public class PartidaController {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "OK", response = PartidaModelResponse.class),
			@ApiResponse(code = 400, message = "Bad request", response = StandardError.class),
			@ApiResponse(code = 401, message = "Unauthorized", response = StandardError.class),
			@ApiResponse(code = 403, message = "Forbidden", response = StandardError.class),
			@ApiResponse(code = 404, message = "Not found", response = StandardError.class),
	...
	@GetMapping
	public ResponseEntity<PartidaModelResponse> listarPartidas() {
