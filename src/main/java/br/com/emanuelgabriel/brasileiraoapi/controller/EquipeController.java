...
import br.com.emanuelgabriel.brasileiraoapi.service.EquipeService;
...
@Api("API de equipes")
@RestController
@RequestMapping(value = "/api/v1/equipes", produces = MediaType.APPLICATION_JSON_VALUE)
public class EquipeController {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "OK", response = EquipeModelResponse.class),
			@ApiResponse(code = 400, message = "Bad request", response = StandardError.class),
			@ApiResponse(code = 401, message = "Unauthorized", response = StandardError.class),
			@ApiResponse(code = 403, message = "Forbidden", response = StandardError.class),
			@ApiResponse(code = 404, message = "Not found", response = StandardError.class),
	...
	@GetMapping
	public ResponseEntity<EquipeModelResponse> listarEquipes() {
	...
	@ApiOperation(value = "Atualizar equipe por ID")
	@ApiResponses(value = {
