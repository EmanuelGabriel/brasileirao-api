...
public class Partida implements Serializable {
	...
	public Partida(Long id, String statusPartida, Equipe equipeCasa, Equipe equipeVisitante, Integer placarEquipeCasa,
			Integer placarEquipeVisitante, String golsEquipeCasa, String golsEquipeVisitante,
			Integer placarEstendidoEquipeCasa, Integer placarEstendidoEquipeVisitante, Date dataHoraPartida,
			String localPartida, String tempoPartida) {
		this.id = id;
