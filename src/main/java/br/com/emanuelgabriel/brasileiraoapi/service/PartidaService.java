...
import br.com.emanuelgabriel.brasileiraoapi.repository.PartidaRepository;
...
public class PartidaService {
	...
	public PartidaModelResponse listarPartidas() {
		PartidaModelResponse partidas = new PartidaModelResponse();
